...
import { assignedDoctorApi } from '../../api/doctorPatientApi';
...
const Home: React.FC = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const res = await assignedDoctorApi();
                if (res.success) {
    ...
    return (
        <div className=''>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 lg:gap-y-9 md:gap-6 gap-6 mt-10 p-6">
                <Card5
